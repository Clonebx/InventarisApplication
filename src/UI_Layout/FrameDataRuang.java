...
import UI_Dialog.FormDataRuang;
 ...
 * @author HP
 */
public class FrameDataRuang extends javax.swing.JFrame {

    /**
     * Creates new form Frame_DataRuang
     */
    
    Connection connection;
    DefaultTableModel dtm;
    public FrameDataRuang() {
        initComponents();
    ...
    private void loadRuang(){
        String[] kolom = {"ID Ruang","Nama Ruang","Keterangan"};
        dtm = new DefaultTableModel(null, kolom);
        try {
            ResultSet rs = connection.createStatement().executeQuery("SELECT * FROM ruang");
            while(rs.next()){
                String id = rs.getString("id_ruang");
                String nama = rs.getString("nama_ruang");               
    ...
    private void initComponents() {
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Ruang", "Nama Ruang", "Keterangan"
            }
        ));
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        new FormDataRuang(this, true, null, null).setVisible(true);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDataRuang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDataRuang().setVisible(true);
            }
        });
    }
