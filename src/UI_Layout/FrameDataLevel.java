 ...
 * @author HP
 */
public class FrameDataLevel extends javax.swing.JFrame {

    /**
     * Creates new form Frame_DataLEvel
     */
    Connection connection;
    DefaultTableModel dtm;
    public FrameDataLevel() {
        initComponents();
    ...
    private void loadLevel(){
        String[] kolom = {"ID Level","Nama Level","Keterangan"};
        dtm = new DefaultTableModel(null, kolom);
        try {
            ResultSet rs = connection.createStatement().executeQuery("SELECT * FROM level");
            while(rs.next()){
                String id = rs.getString("id_level");
                String nama = rs.getString("nama_level");               
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDataLevel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDataLevel().setVisible(true);
            }
        });
    }
