...
import UI_Dialog.FormDataPegawai;
...
public class FrameDataPegawai extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Frame_DataPegawai
     */
    ...
    private void loadPegawai(){
        String[] kolom = {"NIP","Nama Pegawai","Alamat","Username","Password","ID Level"};
        dtm = new DefaultTableModel(null, kolom);
        try {
            ResultSet rs = connection.createStatement().executeQuery("SELECT * FROM pegawai INNER JOIN level ON (pegawai.id_level = level.id_level)");
            while(rs.next()){
                String id = rs.getString("nip");
                String nama = rs.getString("nama_pegawai");               
                String alamat = rs.getString("alamat");
                String username = rs.getString("Username");
                String password = rs.getString("Password");
                String id_level = rs.getString("id_level");
                dtm.addRow(new String[]{id,nama,alamat,username,password,id_level});
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        new FormDataPegawai(this, true, null, null).setVisible(true);
