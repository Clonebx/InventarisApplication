 ...
 * @author HP
 */
public class FrameDataPeminjaman extends javax.swing.JFrame {

    /**
     * Creates new form Frame_DataPeminjaman
     */
    public FrameDataPeminjaman() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDataPeminjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDataPeminjaman().setVisible(true);
            }
        });
    }
