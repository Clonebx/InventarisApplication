...
import UI_Dialog.FormDataPetugas;
 ...
 * @author HP
 */
public class FrameDataPetugas extends javax.swing.JFrame {

    /**
     * Creates new form Frame_DataPetugas
     */
    Connection connection; 
    DefaultTableModel dtm;
    public FrameDataPetugas() {
        initComponents();
    ...
    private void loadPetugas(){
        String[] kolom = {"ID Petugas","Nama Petugas","Username","Password","ID Level"};
        dtm = new DefaultTableModel(null, kolom);
        try {
            ResultSet rs = connection.createStatement().executeQuery("SELECT * FROM petugas INNER JOIN level ON (level.id_level = petugas.id_level)");
            while(rs.next()){
                String id = rs.getString("id_petugas");
                String nama = rs.getString("nama_petugas");               
                String username = rs.getString("username");
                String password = rs.getString("password");
                String id_level = rs.getString("id_level");           
                dtm.addRow(new String[]{id,nama,username,password,id_level});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FrameDataLevel intent = new FrameDataLevel();
        intent.setVisible(true);
        FrameDataPetugas.this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        new FormDataPetugas(this, true, null, null).setVisible(true);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDataPetugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDataPetugas().setVisible(true);
            }
        });
    }
