...
public class FormDataBarang extends javax.swing.JDialog {
    ...
    public FormDataBarang(java.awt.Frame parent, boolean modal, String action, String id) {
        super(parent, modal);
        initComponents();
        settingComponent();
        connection = Database.DatabaseConnection.getConnection();
        addItemCombo("jenis", jComboBox2, "nama_jenis");
        addItemCombo("ruang", jComboBox1, "nama_ruang");
        addItemCombo("petugas", jComboBox3, "nama_petugas");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String jumlah = jTextField2.getText().trim();
        String kondisi = jTextField3.getText().trim();
        String keterangan = jTextField4.getText().trim();
        int ruang = jComboBox1.getSelectedIndex()+1;
        int jenis = jComboBox2.getSelectedIndex()+1;
        int id_petugas = jComboBox3.getSelectedIndex()+1;
            
        String query = "INSERT INTO inventaris(nama_barang,jumlah,kondisi,keterangan,id_ruang,id_jenis,id_petugas) VALUES ('"+nama+"','"+jumlah+"','"+kondisi+"','"+keterangan+"','"+ruang+"','"+jenis+"','"+id_petugas+"')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDataBarang dialog = new FormDataBarang(new javax.swing.JFrame(), true, null, null);
